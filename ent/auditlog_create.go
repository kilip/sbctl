...
func (_c *AuditLogCreate) SetMetadata(v json.RawMessage) *AuditLogCreate {
	_c.mutation.SetMetadata(v)
	return _c
}

// SetCreated sets the "created" field.
func (_c *AuditLogCreate) SetCreated(v time.Time) *AuditLogCreate {
	_c.mutation.SetCreated(v)
	return _c
}

// SetNillableCreated sets the "created" field if the given value is not nil.
func (_c *AuditLogCreate) SetNillableCreated(v *time.Time) *AuditLogCreate {
	if v != nil {
		_c.SetCreated(*v)
	}
	return _c
...
func (_c *AuditLogCreate) check() error {
	...
	if _, ok := _c.mutation.Created(); !ok {
		return &ValidationError{Name: "created", err: errors.New(`ent: missing required field "AuditLog.created"`)}
	}
